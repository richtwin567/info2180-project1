...
window.addEventListener("DOMContentLoaded", (e) => {
	var heroimg = document.getElementsByClassName("overview-hero-image").item(0)
		.children[0];
	...
	cardimg1.setAttribute(
		"src",
		"./images/undraw_Artificial_intelligence_re_enpp.svg"
	);
	delete cardimg1;
	...
	var articleimg1 = document.getElementsByTagName("article").item(0)
		.children[0];
	articleimg1.setAttribute(
		"src",
		"./images/haydn-golden-wcvuv00UDd4-unsplash.jpg"
	);
	delete articleimg1;

	var articleimg2 = document.getElementsByTagName("article").item(1)
		.children[0];
